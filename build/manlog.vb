...
Public Class manlog
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Conn.State = ConnectionState.Open Then Conn.Close()
            Conn.Open()
            Dim cmd0 As New SqlCommand("select * from manlog where userid='" & TextBox1.Text & "' and password='" & TextBox2.Text & "'", Conn)
    ...
    Private Sub manlog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ""
        TextBox2.Text = ""
    End Sub
End Class